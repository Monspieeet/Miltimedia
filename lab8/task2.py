...
net = cv2.dnn.readNetFromDarknet('lb8/resources_for_yolo/yolov3_tiny_face.cfg', 'lb8/resources_for_yolo/yolov3-tiny_face.weights')

fourcc = cv2.VideoWriter_fourcc(*'XVID')
res = cv2.VideoWriter('lb8/result/yolo_output.avi', fourcc, 20.0, (640, 480))
