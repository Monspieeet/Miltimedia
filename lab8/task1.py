...
face_cascade = cv2.CascadeClassifier('lb8\sources_for_haarscade\haarcascade_frontalface_default.xml')

fourcc = cv2.VideoWriter_fourcc(*'XVID')
out = cv2.VideoWriter('lb8/result/haarscade_output.avi', fourcc, 20.0, (640, 480))
